...
base_model = InceptionV3(include_top=False, weights='imagenet',input_shape=(300, 300, 3), classes=2)
...
outputs = keras.layers.Dense(500, activation='relu')(outputs)
outputs = keras.layers.Dense(250, activation='relu')(outputs)
outputs = keras.layers.Dense(50, activation='relu')(outputs)
...
classifier = model.fit(images_train_dataset, validation_data=images_validation_dataset, batch_size=128, epochs=15)
...
print('Flattening prediction output 1D array ...............')
predicted_result = np.reshape(predicted_result, -1)
#10 Step = Padroniza a saída em valores inteiros para utilizarmos calcularmos as métricas
predicted_result = np.where(predicted_result > 0.5, 1, 0)
print('Model predict output............... : {0}'.format(predicted_result))

print('Salvano resultado do treinamento ...............')
...
plt.savefig('model_binary_accuracy_classifier.png')

# ------------------- Printing Error Image ------------------- 
print('Loss...............: ', classifier.history['loss'])
plt.figure()
...
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('model_binary_error_classifier.png')

# ------------------- Printing Multiclass Confusion Matrix Report -------------------
# Documentação: 
#   https://scikit-learn.org/stable/modules/generated/sklearn.metrics.confusion_matrix.html
#   http://rasbt.github.io/mlxtend/user_guide/evaluate/confusion_matrix/#example-2-multi-class-classification
...
cmd.plot()
plt.savefig('model_binary_confusion_matrix.png')
...
fpr, tpr, thresholds = roc_curve(model_test_dataset_true_classification, predicted_result)
print('ROC Curve for BENIGN x MALIGNANT class...............: True Positive = {}, False Positive = {}'.format(tpr, fpr))
roc_auc = auc(fpr, tpr)
print('Area Under the Curve for BENIGN x MALIGNANT class...............:', roc_auc)

plt.figure()
plt.plot(fpr, tpr, label='InceptionV3 ROC curve (area = %0.2f)' % roc_auc)
plt.plot([0, 1], [0, 1], 'k--',label='No Skill')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('BENIGN x MALIGNANT - ROC Curve')
plt.legend(loc="lower right")
plt.savefig('model_binary_roc_curve.png'.format(class_names))